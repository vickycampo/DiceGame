...
public class JdbcDataSource
{
    ...
    private static final String url = "jdbc:mysql://localhost:3307/db_dicegame?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
